...
func NewOperatorContext(k8sClient client.Client, recorder record.EventRecorder, instance CommonOperator, release ChartRelease) (*OperatorContext, error) {
	oCtx := OperatorContext{}
	oCtx.K8sClient = k8sClient
	oCtx.Recorder = recorder
	oCtx.Instance = instance
	oCtx.ChartRelease = release
